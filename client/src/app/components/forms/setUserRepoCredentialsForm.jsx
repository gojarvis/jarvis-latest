...
class SetUserRepoCredentials extends Component {
    ...
    async saveRepoCreds() {
        ...
        let credentials = await agent.post("/api/user/setRepoCredentials", {
            username,
            password,
            address
        });
            ...
            <div style={{ margin: "10px" }}>
                <div>
                    <TextField
                        hintStyle={{ color: "#888" }}
                        textStyle={{ color: "#888" }}
                        hintText="Repo Address"
                        value={this.state.address}
                        onChange={this.updateRepoAddress.bind(this)}
                    />
                </div>
                <div>
                    <TextField
                        ...
                        onChange={this.updateRepoUsername.bind(this)}
                    />
                </div>
                <div>
                    <TextField
                        ...
                        onChange={this.updateRepoPassword.bind(this)}
                    />
                </div>
                <div>
                    <RaisedButton
