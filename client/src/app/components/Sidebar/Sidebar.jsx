    ...
    render() {
        ...
        if (this.state.isAdmin) {
            admin = (
                <div style={styles.navbar.item.wrapper} title="Admin">
                    <AdminIcon
                        style={styles.navbar.item.content}
        ...
        return (
            <div style={styles.sidebar}>
                ...
                <div
                    style={styles.navbar.item.wrapper}
                    title="Connection Explorer"
                >
                    <ConnectionExplorerIcon
                        style={{
                            ...styles.navbar.item.content,
                            ...isSelected(/main/)
                        }}
                        onClick={() => this.handleNavigation("/main")}
                    />
                </div>
                ...
                <div style={styles.navbar.item.wrapper} title="Reports">
                    <ReportsIcon
                        ...
                        onClick={() => this.handleNavigation("report")}
                    />
                </div>
