...
class Main extends React.Component {
    ...
    respond(incoming) {
        ...
        switch (incoming.intent) {
            ...
            case "query_features":
                this.say(
                    queryPurposeResponses.getAllFeatures(incoming).join(".")
                );
                break;
            case "query_time":
                ...
                >
                    ...
                    >
                        <Feedback
                            ref="related"
                            type="svg"
                            tick={this.state.heartValue}
                            items={this.state.related}
                        />
                        <Feedback
                            ref="kwrelated"
                            type="svg"
                            tick={this.state.heartValue}
                            items={this.state.kwrelated}
                        />
                        <Feedback
                            ref="relatedfiles"
                            type="svg"
                            tick={this.state.heartValue}
                            items={this.state.relatedFiles}
                        />
                        <Feedback
                            ref="recommendations"
                            type="svg"
