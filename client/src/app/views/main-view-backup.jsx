...
class MainView extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        checkProps.forEach((item, index) => {
            if (
                nextProps.queriedItems.focusedNodeId !== undefined &&
        ...
        if (willFetch) {
            this.props.dispatch(
                ActionCreators.fetchQueryItemsIfNeeded(
                    nextProps.queriedItems.focusedNodeId
                )
            );
        }
    }
    ...
    async componentWillMount() {
        ...
        this.socket.on("system-event", msg => {
            ...
            if (this.props.queriedItems.autoswitch) {
                this.props.dispatch(
                    ActionCreators.fetchQueryItemsIfNeeded(msg.data.nodeId)
                );
            }
        });
                ...
                <div style={layout.container}>
                    ...
                    <div style={styles.toggle}>
                        ...
                        <Toggle
                            ...
                            onToggle={() => {
                                this.props.dispatch(
                                    ActionCreators.toggleAutoswitch()
                                );
                            }}
