...
class ProfileView extends Component {
    ...
    async init() {
        agent
            .post("http://localhost:3000/api/user/userjson")
            .then(async res => {
    ...
    async getUserTeamInvites(user) {
        let res = await agent.post(
            "http://localhost:3000/api/user/teams/invites",
    ...
    async joinTeam(teamname) {
        ...
        let relationship = await agent.post("/api/user/join", {
            username,
            teamname
        });
    }
                ...
                <div style={{ ...styles.container }}>
                    ...
                    <div style={{ background: "#efefef", color: "#333" }}>
                        ...
                        <div style={styles.block}>
                            ...
                            <Subtitle>
                                Jarvis will track projects in this folder
                            </Subtitle>
            ...
            <div style={styles.block}>
              ...
              <SetUserActivityManagerForm />
                        ...
                        <div style={styles.block}>
                            ...
                            <Subtitle>
                                If enabled, only URLs matching the white list
                                regular expression will be tracked (the rest
                                will not){" "}
                            </Subtitle>
                            <WhiteListForm />
                        </div>
                        ...
                        <div style={styles.block}>
                            ...
                            <Subtitle>
                                If enabled, URLs matching the black list regular
                                expression will not be tracked{" "}
                            </Subtitle>
                            <BlackListForm />
                        </div>
                    </div>
