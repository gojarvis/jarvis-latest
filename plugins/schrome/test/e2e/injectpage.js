...
describe("inject page (in github.com/jhen0409/react-chrome-extension-boilerplate)", function() {
    ...
    it("should render inject app", async () => {
        await this.driver.wait(
            () =>
                this.driver
                    .findElements(
                        webdriver.By.className("inject-react-example")
                    )
    ...
    it('should link to repo page with click "view repo" link', async () => {
                ...
                this.driver
                    .findElements(
                        webdriver.By.className(
                            "inject-react-example-repo-button"
                        )
                    )
                    .then(elems => elems.length > 0),
            10000,
        ...
        this.driver
            .findElement(
                webdriver.By.className("inject-react-example-repo-button")
            )
            .click();
        await delay(1000);
        ...
        expect(title).to.equal(
            "jhen0409/react-chrome-extension-boilerplate · GitHub"
        );
    });
});
