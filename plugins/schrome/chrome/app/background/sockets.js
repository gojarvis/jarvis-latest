...
let socket = io.connect('http://localhost:3000/chrome', {reconnect: true});
let _tabs = [];
...
chrome.tabs.onHighlighted.addListener(function(active) {
  socket.emit('chrome-highlighted', {
    active: active,
    tabs: _tabs
  });
});
