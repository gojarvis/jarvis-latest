 ...
 */
                    ...
                    Manager.prototype.packet = function(packet) {
                        ...
                        if (!self.encoding) {
                            ...
                            self.encoding = true;
                            this.encoder.encode(packet, function(
                                encodedPackets
                            ) {
                                for (
                                    var i = 0;
 ...
 */
                        ...
                        exports.encodePayloadAsArrayBuffer = function(
                            ...
                            map(packets, encodeOne, function(
                                ...
                                var totalLength = encodedPackets.reduce(
                                    function(acc, p) {
                                        var len;
                                        if (typeof p === "string") {
                                            len = p.length;
                        ...
                        exports.encodePayloadAsBlob = function(
                            ...
                            function encodeOne(packet, doneCallback) {
                                exports.encodePacket(
                                    ...
                                    true,
                                    function(encoded) {
                                        var binaryIdentifier = new Uint8Array(
                                            1
                                        );
                    ...
                    Decoder.prototype.add = function(obj) {
                        ...
                        if ("string" == typeof obj) {
                            ...
                            if (
                                ...
                                if (
                                    this.reconstructor.reconPack.attachments ===
                                    0
                                ) {
                            ...
                            if (!has("json-parse")) {
                                ...
                                var walk = function(
                                    ...
                                    if (typeof value == "object" && value) {
                                        ...
                                        if (
                                            getClass.call(value) == arrayClass
                                        ) {
                                            for (
                                                length = value.length;
                                                length--;
